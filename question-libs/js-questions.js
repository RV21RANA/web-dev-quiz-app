const jsQuestions = [
    {
        ...
        answer: 'JS gives variables a `reference` to where objects are stored in the memory'
    },
    {
    ...
    },
    {
        ...
        answer: 'Allows JavaScript to make multiple requests to multiple servers without loading a new page',
    },
]